...
export default class {
	constructor(div) {
		...
		this.contentDivName = 'committeesContent'
	...
	createStructure() {
        ...
        <div class="row">
            <div class="col-md-2 col-sm-6 col-xs-6" >
                <div id="committeesMenu" style="border-right: 4px solid #007d40;"></div>
            </div>
	...
	displayIntro() {
		this.contentDiv.innerHTML = `
		<div class="container"> 
			<h3>Department Committees (${this.academicYear}) </h3>	
		<p>Please click on a semester 
		from the Menu on the left to display its committees</p></div>
		`
	}

	displayMenu() {
		let menuDiv = document.getElementById('committeesMenu')
